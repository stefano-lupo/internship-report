...
\textbf{Note: for the sake of the report, the bucket size was used. However the code makes frequent use of the number of host bits. These are related through \refeq{eq:bucketSizeHostBits}}
